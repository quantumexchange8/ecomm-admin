                        ...
                        <Table className="bg-gray-100" >
                            ...
                            <TableHeader className="px-4 py-3 ">
                                <TableRow className="border-b  border-gray-200">
                                    ...
                                    <TableHead className="px-4 py-3 font-semibold text-gray-700">Parent ID</TableHead>
                                    <TableHead className="px-4 py-3 font-semibold text-gray-700">Level</TableHead>
                    ...
                    <DialogContent>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                {/* Color Picker */}
                                <div className="col-span-2">
                                    <label htmlFor="color" className="block text-sm font-medium text-gray-700">Category Color</label>
                                    <input
                                        id="color"
                                        name="color"
                                        type="color"
